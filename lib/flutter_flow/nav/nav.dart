...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      errorBuilder: (context, state) =>
          appStateNotifier.loggedIn ? const ContactWidget() : const ProjectsWidget(),
      routes: [
        FFRoute(
          name: '_initialize',
          path: '/',
          ...
          routes: [
            ...
            FFRoute(
              name: 'resumePage',
              path: 'resumePage',
              builder: (context, params) => const ResumePageWidget(),
            ),
            FFRoute(
              name: 'HomePageCopy',
              path: 'homePageCopy',
            ...
            FFRoute(
              name: 'ProjectsCopy',
              path: 'projectsCopy',
              builder: (context, params) => const ProjectsCopyWidget(),
            )
